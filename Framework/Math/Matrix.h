...
inline Vec3 TransformPoint(const Matrix4x4f& matrix, Vec3& point)
{
    Vec4 hSpace = Vec4(point.x, point.y, point.z, 1);
...
inline Vec3 TransformVector(const Matrix4x4f& matrix, Vec3& vector)
{
    Vec4 hSpace = Vec4(vector.x, vector.y, vector.z, 0);
    Vec4 tmp = Vec4(0, 0, 0, 0);
...
inline Vec3 TransformVector(const Matrix3x3& matrix, Vec3& vector)
{
    Vec3 tmp = Vec3(0, 0, 0);
    for (int r = 0; r < 3; ++r) {
        for (int c = 0; c < 3; ++c) {
...
inline void BuildMatrixViewLookatRH(Matrix4x4f& matrix, const Vec3& position, const Vec3& lookAt, const Vec3& up) {
...
inline void BuildMatrixViewLookatLH(Matrix4x4f& matrix, const Vec3& position, const Vec3& lookAt, const Vec3& up) {
    Vec3 xaxis, yaxis, zaxis;
    float tmp1, tmp2, tmp3;
...
inline void BuildMatrixRotationAxis(Matrix4x4f& matrix, const Vec3& axis, const float radio) {
...
inline void BuildVec3TransformCoord(Vec3& VOut, const Vec3& V, Matrix4x4f& M) {
